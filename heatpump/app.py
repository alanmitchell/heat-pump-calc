...
app.layout = html.Div([
    ...
    dcc.Input(id='ht_eff', type='text'), html.Abbr(" &nbsp; ", title="Enter the efficiency of your existing heating system here. This is often listed as the AFUE on the label."),
    html.Br(),
